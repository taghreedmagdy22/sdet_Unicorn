...
public class ReadPropertiesFile {
    ...
    private static  final String productDetailsPath = System.getProperty("user.dir") + "/src/test/resources/product.properties";
    ...
    public static Properties setProductDetails() throws IOException {
        Properties profileProperties = new Properties();
        FileInputStream inputStream = new FileInputStream(productDetailsPath);
        profileProperties.load(inputStream);
        return profileProperties;
    }
